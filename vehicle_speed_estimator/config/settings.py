...
HIGHLIGHT_SPEEDING_TRACES = True
SPEEDING_TRACE_COLOR = (0, 0, 255)  # BGR 红色
SPEEDING_TRACE_THICKNESS = 2
HIGHLIGHT_SPEEDING_LABELS = True
SPEEDING_LABEL_BG_COLOR_HEX = "#FF4D4D"  # 浅红色，十六进制格式
NORMAL_LABEL_BG_COLOR_HEX = "#000080"  # 海军蓝色，十六进制格式
